                            ...
                            <div class="portfolio-grid">
                                ...
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-content">
                                        ...
                                        <a href="https://web.archive.org/web/20140517191508/http://m3alem.com/"
                                ...
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-content">
                                        ...
                                        <a href="https://test.3rosesmenage.net/" target="_blank"
                                ...
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-content">
                                        ...
                                        <a href="https://portfolio.3rosesmenage.net/" target="_blank"
                                            class="btn btn-primary">
                                            <?php echo $lang_data['portfolio_view_project']; ?>
                                        </a>
                                    </div>
                                ...
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-content">
                                        ...
                                        <a href="https://edificesbrillants.com/" target="_blank"
                                            class="btn btn-primary">
                                            <?php echo $lang_data['portfolio_view_project']; ?>
                                        </a>
                                    </div>
                                ...
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-content">
                                        ...
                                        <a href="https://github.com/biko2020?tab=repositories" target="_blank"
                                            class="btn btn-primary">
                                            <?php echo $lang_data['portfolio_view_project']; ?>
                                        </a>
                                    </div>
                    ...
                    <section id="about-me">
                        <div class="container">
                            ...
                            <div class="about-content">
                                <div class="intro">
                                    <h3><?php echo $lang_data['about_subtitle']; ?></h3>
                                    <p>
                                    ...
                                    <p>
                                        <strong><?php echo $lang_data['about_contact_message']; ?></strong>
                                    </p>
                                </div>
                                <div class="skills">
                                    <h3><?php echo $lang_data['about_key_skills_title']; ?></h3>
                                    <ul>
                                        <li><strong><?php echo $lang_data['about_skill_1_title']; ?></strong> <?php echo $lang_data['about_skill_1_description']; ?></li>
                                        <li><strong><?php echo $lang_data['about_skill_2_title']; ?></strong> <?php echo $lang_data['about_skill_2_description']; ?></li>
                                        <li><strong><?php echo $lang_data['about_skill_3_title']; ?></strong> <?php echo $lang_data['about_skill_3_description']; ?></li>
                                        <li><strong><?php echo $lang_data['about_skill_4_title']; ?></strong> <?php echo $lang_data['about_skill_4_description']; ?></li>
                                        <li><strong><?php echo $lang_data['about_skill_5_title']; ?></strong> <?php echo $lang_data['about_skill_5_description']; ?></li>
                                        <li><strong><?php echo $lang_data['about_skill_6_title']; ?></strong> <?php echo $lang_data['about_skill_6_description']; ?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            ...
                            <div class="contact-info">
                                <div class="contact-info-item">
                                    ...
                                    <h3><?php echo $lang_data['contact_phone_label']; ?></h3>
                                    <p><?php echo $lang_data['contact_phone']; ?></p>
                                </div>
                                <div class="contact-info-item">
                                    <i class="fas fa-envelope"></i>
                                    <h3><?php echo $lang_data['contact_email_label']; ?></h3>
                                    <p><?php echo $lang_data['contact_email']; ?></p>
                                </div>
                            </div>
                            ...
                            <form class="contact-form" action="send_message.php" method="post">
                                ...
                                <textarea name="message" placeholder="<?php echo $lang_data['contact_form_message']; ?>" required></textarea>
