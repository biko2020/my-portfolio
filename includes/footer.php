<footer>
  ...
  <nav class="footer-menu">
    ...
    <div class="footer-menu-item">
      <a href="/includes/display_testimonials.php">
        <?php echo $lang_data['footer_testimonials']; ?>
      </a>
    </div>
    <div class="footer-menu-item">
      <a href="https://docs.google.com/document/d/1M0Zg7cv-qH_izfG1d96j2YaOlGOZxlTD6ilJFvHfTho/edit?usp=sharing" download>
